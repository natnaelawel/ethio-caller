...
public class secondRecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    int dir;
    ...
    * */
    ...
    public secondRecyclerItemTouchHelper(int dragDirs, int swipeDirs, RecyclerItemTouchHelperListener listener) {
    ...
    public void clearView(@NonNull RecyclerView recyclerView,
        ...
        final View foregroundView=((MyFavouriteAdapter.MyViewHolder) viewHolder).viewForeground;
...
//        super.onChildDrawOver(c, recyclerView, viewHolder, dX, dY, actionState, isCurrentlyActive);
    ...
    public void onSelectedChanged(@Nullable RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder!=null){
            final View forgroundView =((MyFavouriteAdapter.MyViewHolder) viewHolder).viewForeground;
